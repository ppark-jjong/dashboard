...
def process_and_save_data(spark):
    """
    데이터 로드, 전처리 및 저장 공통 로직
    """
    try:
        # 데이터 로드
        if MODE == "local":
